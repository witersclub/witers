...
const SYSTEM_PROMPT =
  ...
  "escribieron (a veces coloquiales, con muletillas o afirmaciones sueltas). Tu única salida " +
  "es el prompt final en español, listo para que un diseñador lo pegue TAL CUAL en otra IA " +
