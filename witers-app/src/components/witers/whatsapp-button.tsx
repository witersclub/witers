...
export function WhatsAppFloatButton() {
  ...
  return (
    <a
      ...
      className={`fixed right-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_20px_rgba(0,0,0,0.22)] transition hover:brightness-105 active:scale-95 sm:right-6 sm:h-14 sm:w-14 sm:bottom-[calc(6rem+0.5cm)] ${mobileBottomClass}`}
    >
